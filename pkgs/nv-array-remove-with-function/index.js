...
function all(arr,cond_func,...other_params) {
    ...
    let narr = arr.filter((r,i)=>!indexes.includes(i))
...
function which(arr,index,cond_func,...other_params) {
    which_engine(gen_from_fst,index,arr,cond_func,...other_params)
    return(arr)
}

function which_from_lst(arr,index,cond_func,...other_params) {
    which_engine(gen_from_lst,index,arr,cond_func,...other_params)
    return(arr)
}
